    ...
    <footer className='bg-black py-7'>
      ...
      <div className='container mx-auto'>
        <p className='text-white text-center'>
          ...
          Design & Developed By   <a className='underline cursor-pointer animate-pulse  hover:text-blue-500 duration-500' href="https://fabulous-tanuki-09bb4a.netlify.app/" target="_blank" rel="noreferrer">Jaimin Panchal </a>
